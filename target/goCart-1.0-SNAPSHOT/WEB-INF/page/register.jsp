					...
					<div class="col-sm-12">
						<div class="row">
							...
							<div class="col-sm-6 form-group">
								<form:label path="firstName">First Name<span>*</span></form:label>
								<form:input type="text" placeholder="Enter First Name"
									class="form-control" path="firstName"></form:input>
								<form:errors path="firstName"></form:errors>
							</div>
							<div class="col-sm-6 form-group">
								<form:label path="lastName">Last Name<span>*</span></form:label>
						...
						<div class="row">
							<div class="col-sm-6 form-group">
								<form:label path="user.emailId">Email Id<span>*</span></form:label>
							...
							<div class="row">
								<div class="col-sm-6 form-group">
									<form:label path="user.password">Password<span>*</span></form:label>
